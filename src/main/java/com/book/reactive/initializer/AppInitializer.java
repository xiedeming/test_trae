    ...
    private void cacheChapter(CountDownLatch latch, Flux<Book> books) {
        ...
        books
            ...
            .doOnSuccess(count -> {
                ...
                reactiveRedisTemplate.opsForValue().set(INIT_CHAPTER_URL_KEY, 1, Duration.ofHours(23)).subscribe();
                latch.countDown();
            })
            .doOnError(error -> {
    ...
    private void cacheBook(CountDownLatch latch, Flux<Book> books) {
        ...
        books
            ...
            .doOnSuccess(count -> {
                ...
                reactiveRedisTemplate.opsForValue().set(INIT_BOOK_NAME_KEY, 1, Duration.ofHours(23)).subscribe();
                latch.countDown();
            })
            .doOnError(error -> {
